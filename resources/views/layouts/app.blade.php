        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="dist/img/evertec.png" alt="Evertec Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .9">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="dist/img/login.jpg" class="img-circle elevation-2" alt="login image">
                        </div>
                        <div class="info">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="dist/img/register.jpg" class="img-circle elevation-2" alt="register image">
                        </div>  
